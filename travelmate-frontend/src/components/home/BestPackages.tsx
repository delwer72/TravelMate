                ...
                <div className="p-6 pt-0">
                  <div className="flex items-center justify-between pt-3.5 border-t border-slate-100 dark:border-slate-800/80">
                    ...
                    <button
                      ...
                      className="text-xs font-bold px-4.5 py-2 rounded-xl bg-gradient-to-r from-emerald-600 via-teal-500 to-cyan-500 hover:from-emerald-500 hover:to-cyan-400 text-white shadow-md shadow-emerald-600/20 hover:scale-105 active:scale-95 transition cursor-pointer"
                    >
                      Book Now
                    </button>
                  </div>
